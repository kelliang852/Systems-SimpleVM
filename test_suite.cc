...
void HW4Environment::AddPoints(int points) {
  ...
  cout << " (" << total_points_ << "/" << HW4_TEST_SUITE_MAXPOINTS << ")"<< endl;
}
...
void HW4Environment::SetUp() {
  cout << "HW4: there are " << HW4_TEST_SUITE_MAXPOINTS;
...
void HW4Environment::TearDown() {
  ...
  cout << HW4_TEST_SUITE_MAXPOINTS << " points available (";
  cout << ((100.0 * total_points_) / HW4_TEST_SUITE_MAXPOINTS) << "%)" << endl;
  cout << endl;
}
